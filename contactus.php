	...
	<div class="contactus"  style="background-color:#fff;">
		...
		<div class="main_content">
			<div class="col-md-6" style="border-right: 2px solid black;">
				<article>
					<h2>Swati Ranjan <h2><h4>Masters Of Computer application</h4>
							<h5>University Of Hyderabad</h5>
							https://linkedin.com/in/developerazad <br>
						<p> https://ranjanswati.twitter.com <br>
							https://facebook/swatiranjan <br>
							cell: +91 7004087911</p><br>
				</article>
			</div>
			<div class="col-md-6">
